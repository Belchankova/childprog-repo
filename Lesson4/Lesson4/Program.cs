...
namespace Lesson4
{
    class StringManipulator
    {
        public static string ReplaceAndRemoveDigits(string input)
        {
            ...
            string result = Regex.Replace(replacedString, @"\d", "");
            return result;
        }
        ...
        public static void ABC(string input)
        {
            ...
            int abc = input.IndexOf("abc");
            if (abc != -1)
            {
                beforeABC = input.Substring(0, abc);
                afterABC = input.Substring(abc + 3);
            }
        ...
        public static void Sixth(string documentNumber) //5.6
        {
            ...
            {
                Console.WriteLine("The document number starts with the sequence 555.");
            }
            else
            {
                Console.WriteLine("The document number does not start with the sequence 555.");
            }
        }
